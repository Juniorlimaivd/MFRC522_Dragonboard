 ...
 * Constructor.
 */
MFRC522::MFRC522(): MFRC522(SS, 2147483647) { // SS is defined in pins_arduino.h, UINT8_MAX means there is no connection from Arduino to MFRC522's reset and power down input
} // End constructor
...
void MFRC522::PCD_Init() {
	...
	if (_resetPowerDownPin != 2147483647) {
